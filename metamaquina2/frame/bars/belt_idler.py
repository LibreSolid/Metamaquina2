...
class BeltIdler(AssemblyNode):
    ...
    def render(self):
        """Stack the idler, and leave the third washer out of one that
        is not spaced.

        Nothing on this idler moves, so the stack and the presence of
        the spacing washer are both the machine at rest.
        """
