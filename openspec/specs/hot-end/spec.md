# hot-end Specification

## Purpose

Give the machine the thing that melts the filament: the five bought parts of
a J-head, drawn from the shop drawings this repository carries, stacked the
way a builder stacks them, and standing so that the nozzle tip is exactly the
point the machine measures Z from.
